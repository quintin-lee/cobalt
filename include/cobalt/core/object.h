 ...
 * @details All object instances in Cobalt must include this structure at the very beginning of their memory layout,
 *          to ensure the normal operation of polymorphism and reference counting.
 */
 ...
 * 
 * @param obj Pointer to the object whose reference count needs to be increased. If NULL, no operation is performed.
 */
 ...
 * 
 * @param obj Pointer to the object whose reference count needs to be decreased. If NULL, no operation is performed.
 */
