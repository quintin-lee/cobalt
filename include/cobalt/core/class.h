 ...
 * @details Provides the definition of the runtime class structure, supporting the construction of class information, registration of methods and properties, and inheritance mechanisms.
 *
 ...
 * @details Stores class metadata, including name, method table, property table, and inheritance relationships.
 */
 ...
 * @details Describes a method of a class, including the method name and the corresponding function pointer.
 */
