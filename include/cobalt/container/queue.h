 ...
 * 
 * @return Returns a pointer to the newly created queue on success; returns NULL if memory allocation fails.
 */
 ...
 * 
 * @param queue Pointer to the target queue
 * @return User data pointer stored in the original head node; returns NULL if the queue is empty or queue is NULL.
 */
 ...
 * 
 * @param queue Pointer to the target queue
 * @return User data pointer stored in the head node; returns NULL if the queue is empty or queue is NULL.
 */
 ...
 * 
 * @param queue Pointer to the target queue
 * @return Returns 1 if the queue is not NULL and the number of elements is 0; otherwise returns 0. If queue is NULL, returns 0.
 */
