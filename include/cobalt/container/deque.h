 ...
 *
 * A double-ended queue is a linear data structure that allows insertion and deletion operations at
 ...
 *
 * @return Returns a pointer to the newly created double-ended queue on success; returns NULL if
 ...
 *
 * @param deque Pointer to the target double-ended queue
 * @return User data pointer stored in the original front node; returns NULL if the queue is empty
 * or deque is NULL.
 */
 ...
 *
 * @param deque Pointer to the target double-ended queue
 * @return User data pointer stored in the original back node; returns NULL if the queue is empty or
 * deque is NULL.
 */
 ...
 *
 * @param deque Pointer to the target double-ended queue
 * @return User data pointer stored in the front node; returns NULL if the queue is empty or deque
 * is NULL.
 */
 ...
 *
 * @param deque Pointer to the target double-ended queue
 * @return User data pointer stored in the back node; returns NULL if the queue is empty or deque is
 * NULL.
 */
