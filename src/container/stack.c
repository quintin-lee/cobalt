 ...
 * @details Last-In, First-Out (LIFO) stack structure implemented based on a singly linked list. Each push operation inserts a new node at the head of the linked list.
 */
...
typedef struct stack_node {
    ...
    struct stack_node *next; /* Pointer to the next node, i.e., the element further down in the stack */
} stack_node_t;
 ...
 * @note Does not free the user data (data) memory, if needed, it should be manually popped and freed before destruction
 * 
